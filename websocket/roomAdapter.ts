...
export class Tier4Room extends EngineRoom {
    private stateHistory: Map<string, RoomSnapshot> = new Map();
    ...
    updateMetrics(metrics: {
        ...
        const metricsPanel = document.querySelector(`iframe[src*="metrics"]`)?.contentWindow;
        if (metricsPanel) {
