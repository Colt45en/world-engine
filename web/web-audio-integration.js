...
class WebAudioSemanticProcessor {
    ...
    updateVisualization(output) {
        // Update visualization data
        this.visualizationData.state = output.state;
        this.visualizationData.tempo = output.tempo;
        this.visualizationData.phase = output.phase;
        this.visualizationData.events = output.events;
        this.visualizationData.features = output.features;

        // Emit to visualization components
